# Oystercard - Makers Academy case 2

Author: Aday Mesa

The detailed description of the challenge is:
...
I have used RSpec for unit testing and is written in Ruby. Still is not complete.
